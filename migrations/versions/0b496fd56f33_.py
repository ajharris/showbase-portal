...
Revision ID: 0b496fd56f33
Revises: 
Create Date: 2024-07-07 15:17:44.832321
...
def upgrade():
    ...
    sa.Column('showNumber', sa.String(length=100), nullable=False),
    sa.Column('accountManager', sa.String(length=120), nullable=False),
    sa.Column('location', sa.String(length=200), nullable=True),
    sa.Column('sharepoint', sa.String(), nullable=True),
    sa.Column('active', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['accountManager'], ['worker.email'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('receiptNumber', sa.String(length=50), nullable=True),
    sa.Column('date', sa.Date(), nullable=False),
    sa.Column('accountManager', sa.String(length=120), nullable=True),
    sa.Column('showName', sa.String(length=100), nullable=True),
    sa.Column('showNumber', sa.String(length=100), nullable=False),
    ...
    sa.ForeignKeyConstraint(['showNumber'], ['event.showNumber'], ),
